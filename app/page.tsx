...
export default function Home() {
  ...
  return <main>
    ...
    <section className="panel alert"><div><p className="eyebrow">RIDER NOTIFICATION</p><input value={notice} onChange={e=>{setNotice(e.target.value);setSent(false)}} /></div><button onClick={()=>setSent(true)}>{sent?'✓ Sent to riders':'Send push notification'}</button></section>
